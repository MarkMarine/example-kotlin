...
internal constructor(private val channel: ManagedChannel) {
    ...
    val tracingInterceptor = ClientTracingInterceptor.Builder(MockTracer())
            .withActiveSpanSource { OpenTracingContextKey.activeSpan() }
            .build()

    private val blockingStub: GreeterGrpc.GreeterBlockingStub = GreeterGrpc.newBlockingStub(tracingInterceptor.intercept(channel))
